...
SYSTEM_PROMPT_INQUIRY = """
    ...
    9. 特定の部署の従業員情報を求められた場合、その部署に所属するすべてのメンバーの詳細情報を表形式で整理して回答してください。
    10.「一覧化」を求められた場合、番号付きリストまたは表形式を使用して、すべての該当者を明確に示してください。
    11. 人事部に関する質問の場合、文脈に含まれる人事部のすべてのメンバー情報を必ず含めて回答してください。人事部には複数名（9名）のメンバーがいるため、全員の情報を提供してください。
    12. 文脈に複数の関連ドキュメントが含まれている場合、すべての関連情報を統合して包括的な回答を提供してください。
    13. 従業員一覧を求められた場合、必ず4名以上の情報が含まれるように、文脈内のすべての該当する従業員を検索して回答してください。特に人事部の場合は9名全員の情報を提供してください。
    14. 部署の従業員情報について質問された場合、その部署のすべてのメンバーの情報を漏れなく記載してください。1名や2名だけではなく、該当部署のすべての従業員を一覧化してください。
